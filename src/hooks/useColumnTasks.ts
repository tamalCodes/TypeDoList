...
function useColumnTasks(column: ColumnType) {
  ...
  const addEmptyTask = useCallback((valuetext:string, columntext:string) => {
    ...
    setTasks((allTasks) => {
      ...
      const newColumnTask: TaskModel = {
        ...
        column: columntext==='Todo'?ColumnType.TO_DO : columntext==='In Progress'?ColumnType.IN_PROGRESS : columntext==='Blocked'?ColumnType.BLOCKED : ColumnType.COMPLETED,
      };
